...
enum ErrorCode: int
{
    ...
    case PARAMETER_NEED_MORE_BYTES_VALUE_MUST_BE_INT_POSITIVE = 203;
    case PARAMETER_TOTAL_READ_BYTES_VALUE_MUST_BE_INT_POSITIVE = 205;
    case PARAMETER_CONTEXT_VALUE_MUST_BY_SCALAR = 206;
